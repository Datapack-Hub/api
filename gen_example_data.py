...
connection.execute("create table projects(type STRING NOT NULL, author INT NOT NULL, title STRING NOT NULL, description STRING NOT NULL, icon STRING, url STRING NOT NULL UNIQUE);")
